...
Запустил mariadb и убедился, что прослушивает порт:
...
Перезапустил MariaDB и снова проверил статус:
...
Я успешно приобрёл практические навыки по установке и конфигурированию 
системы управления базами данных на примере программного обеспечения MariaDB.
